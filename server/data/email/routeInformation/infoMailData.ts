...
<body style="background-color: #340a13; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none">
    <table
        ...
        class="nl-container"
        role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #340a13"
        width="100%"
    >
        <tbody>
            <tr>
                            ...
                            <tr>
                                <td>
                                    <table
                                        ...
                                        role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #2a060e; color: #000000; width: 680px"
                                        width="680"
                                    >
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h3
                                                                    ...
                                                                    "
                                                                >
                                                                    <span class="tinyMce-placeholder">Route-Information</span>
                                                                </h3>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    ...
                                                                    >
                                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 21px">
                                                                            <span style="font-size: 14px">Hallo ${username},<br /><br /></span>
                                                                        </p>
                                                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 13.5px">
                                                                            <span style="font-size: 16px"
                                                                                ><span style="font-size: 14px">Deine nächsten Zugverbindungen haben sich geändert.</span
                                                                                ><span style=""><br /></span></span
                                                                            ><br /><span style="font-size: 9px"
                                                                                ><em>Please note that this information is sent only every 45 minutes.</em></span
                                                                            >
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                ...
                                                >
                                                    <tr>
                                                        <td style="padding: 0 2px 0 2px">
                                                            <a href="https://github.com/Schuetze1000/TheRouteMaster" target="_blank"
                                                                ><img
                                                                    alt="Github"
                                                                    height="32"
                                    ...
                                    <tr>
                                        <td class="pad" style="padding-bottom: 10px; padding-top: 10px">
                                            <div align="center" class="alignment">
                                                ...
                                                >
                                                    <tr>
                                                        <td class="divider_inner" style="font-size: 1px; line-height: 1px; border-top: 1px solid #cccccc">
                                                            <span> </span>
                                                        </td>
                                                    </tr>
                                                </table>
...
function routeElementHeader(routeHeader: String) {
	return `<div>
	<table
		align="center"
		border="0"
												...
												<div style="font-family: sans-serif">
													...
													>
														<p style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px">
															<span style="font-size: 20px"><strong>Zugverbindung ${routeHeader}</strong></span>
														</p>
													</div>
												</div>
											</td>
										...
										<tr>
											<td class="pad" style="padding-bottom: 10px; padding-top: 10px">
												<div align="center" class="alignment">
													...
													>
														<tr>
															<td class="divider_inner" style="font-size: 1px; line-height: 1px; border-top: 1px solid #ff3939">
																<span> </span>
															</td>
														</tr>
													</table>
...
export function routeElement(routeHeader: String, imgURLs: String[], froms: String[], tos: String[], routeNames: String[], price: String) {
	let output = routeElementHeader(routeHeader);
	const len = imgURLs.length;
	if (len != froms.length || len != tos.length || len != routeNames.length) {
		return "";
	}
