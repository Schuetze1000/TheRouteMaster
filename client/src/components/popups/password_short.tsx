...
export function PopupShort({ isVisable = false, onClose }) {
	...
	"UnterstrichUnsterblicher", "PseudocodePrinz", "KernelKönig", "HalloWeltHeld", "StackOverFlowStar", "BashBerserker", 
			...
			<div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
				<div className=" flex flex-col">
					...
					>
						...
						<div className="dark:text-white text-center text-lg font-bold mb-5">Dein gewähltes Passwort wird bereits von dem Nutzer: {funUsernames[randomIntFromInterval(0,33)]} verwendet. Bitte wähle ein anderes.</div>
