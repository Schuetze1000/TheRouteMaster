					...
					>
						...
						<div className="flex justify-between space-x-5 md:space-x-10">
                         ...
                         hover:bg-green-500 sm:ml- sm:w-auto place-self-start"
							...
							<button
								type="submit"
								className="inline-flex w-full justify-center rounded-md bg-red-600 px-5 py-2 text-sm font-semibold text-white shadow-sm \
                         hover:bg-red-500 sm:ml-3 sm:w-auto place-self-end"
								onClick={() => onDiscard()}
							>
								Nicht Speichern
							</button>
