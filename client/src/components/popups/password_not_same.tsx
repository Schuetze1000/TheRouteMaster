export function PopupNotEqual({ isVisable = false, onClose }) {
	if (isVisable) {
		return (
			<div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
				<div className=" flex flex-col">
					...
					>
						...
						<div className="dark:text-white text-center text-lg font-bold mb-5">Deine eingegebenen Passwörter stimmen nicht überein!</div>
