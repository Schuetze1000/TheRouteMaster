            ...
            <form onSubmit={onSubmit}>
                ...
                <div className="flex justify-center flex-col m-auto h-screen">
                    <div className="login-box">
                        ...
                        <p className="text-center text-blacm">Oder melde dich mit deinem Github Account an</p>
                        <button type="button" className="text-white bg-[#24292F] rounded-3xl hover:rounded-xl duration-300 hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
